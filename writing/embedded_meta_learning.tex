...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{figures/poly/meta_results.png}
\caption{The system generalizes to meta-mapping new tasks. The solid line indicates optimal performance.} 
...
\textbf{Meta mapping (task $\rightarrow$ task):} Furthermore, the system is able to perform meta-mappings (mappings over tasks) in order to flexibly reconfigure its behavior, as shown in fig. \ref{poly_meta_map_results}. \par 
