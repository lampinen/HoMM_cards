...
\node [conc] at (-6, -4) (perc) {\textbf{Input}};
%%\node [conc] at (-7.25, -2.5) (lang) {\textbf{Language}};
\node [conc] at (-6, 4) (act) {\textbf{Output}};
...
\caption{The system can rapidly adapt to new tasks. (This figure shows training all parameters while replaying old tasks, unlike the continual learning strategy above.)}
