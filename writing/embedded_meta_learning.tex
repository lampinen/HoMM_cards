...
Each epoch consisted of a separate learning step on each task (both base and meta), in a random order. The embeddings of the tasks for the meta-learner were computed once per epoch, so as the network learned over the course of the epoch, the 
