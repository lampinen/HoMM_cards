\appendix
The supplemental material is organized as follows: In Section \ref{app_clarifying_meta_mapping} we clarify some definitional details. In Section 
...
(Will be included in de-anonymized version.)
