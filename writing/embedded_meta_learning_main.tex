...
\node [dashblock] at (0.2, 0) (rep) {\begin{tabular}{c}$\bm{Z}$: \textbf{Shared} \\ \textbf{representation}\end{tabular}};
...
\node [conc] at (-7, -3.5) (perc) {\textbf{Input}};
%%\node [conc] at (-7.25, -2.5) (lang) {\textbf{Language}};
\node [conc] at (-7.2, 4) (act) {\textbf{Output}};
\node [conc] at (-7.2, 2.8) (tar) {\textbf{Targets}};
...
\node [block, text width=2.2cm] at (-4, 3) (OD) {$\bm{\mathcal{O}}$: \textbf{Output decoder}};
\node [block, text width=2cm] at (-4, 1.5) (TE) {$\bm{\mathcal{T}}$: \textbf{Target encoder}};
...
\node [block] at (4.2, 0) (meta) {\begin{tabular}{c}$\bm{\mathcal{M}}$: \textbf{Meta} \\ \textbf{network}\end{tabular}};
\path [line] (collection.south) to [out=-90, in=-90] (meta.south);
\path [line] (meta.west) to (rep.east);

% hyper

\node [block] at (4.2, 3) (hyper) {\begin{tabular}{c}$\bm{\mathcal{H}}$: \textbf{Hyper} \\ \textbf{network}\end{tabular}};
