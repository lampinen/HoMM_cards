...
ggsave("writing/figures/basic_meta_learning.png", width=5, height=3)
```
...
ggsave("writing/figures/meta_mapping.png", width=5, height=3)
```
...
ggsave("writing/figures/language_meta_mapping.png", width=5, height=3)
