...
result_subdirs = c("nometa",# "nometa_su_heldout", "nometa_random_holdout_longer", "nometa_only_one",  "nometa_only_one_ho",
                   ...
                   "language", "language_noncompositional", "language_simplified", "language_random_holdout", "language_meta")
...
```{r}
language_d = load_d(results_dir, c("language", "language_simplified", "language_random_holdout", "language_meta", "language_noncompositional"), num_runs, "new_language_rewards")
...
ggplot(language_d %>%
         filter(epoch == 0,
                is_new_game),
       aes(x=run_type, y=reward, fill=as.factor(run))) +
...
meta_d = load_d(results_dir, c("basic", 
                               ...
                               "language", "language_random_holdout", "language_simplified", "language_meta"
...
```{r}
lang_meta_d = load_d(results_dir, c("language_meta", "language_simplified"
...
```{r}
ggplot(avg_lang_meta_d, aes(x=meta_task, fill=is_new, y=avg_avg_reward)) +
  geom_bar(stat="identity", position="dodge") +
  geom_errorbar(aes(ymin=ci_lo, ymax=ci_hi), position="dodge") +
  scale_fill_brewer(palette="Set2") +
  facet_wrap(. ~ named_run_type)
