...
result_subdirs = c("nometa",# "nometa_su_heldout", "nometa_random_holdout_longer", "nometa_only_one",  "nometa_only_one_ho",
                   "basic", #"basic_su_heldout", "basic_random_holdout_longer", "basic_only_one", "basic_only_one_ho",
                   "language")
...
```{r}
language_d = load_d(results_dir, result_subdirs, num_runs, "new_language_rewards")
...
meta_d = load_d(results_dir, c("basic", 
                               #"basic_su_heldout", "basic_random_holdout_longer", "basic_only_one", "basic_only_one_ho",
                               "language"), num_runs, "new_meta_true_losses")
