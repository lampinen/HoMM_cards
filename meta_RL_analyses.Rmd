...
```{r}
language_d = load_d(results_dir, c("language", "language_noncompositional", "language_simplified", "language_meta_nontoggling", "language_nontoggling_random_holdout", "language_simplified_random_holdout"), num_runs, "new_language_rewards")
