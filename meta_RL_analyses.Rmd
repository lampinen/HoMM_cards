...
result_subdirs = c("nometa", "nometa_su_heldout", "nometa_random_holdout",
                   "basic", "basic_su_heldout", "basic_random_holdout")
...
reward_d = reward_d %>%
  ...
  mutate(game_type = str_extract(game_str, "high_card|match|straight_flush|pairs_and_high|sum_under"),
         ...
         is_new_game = (!is_random_ho & !is_su_ho & game_str %in% new_game_strs) | (is_su_ho & game_str %in% new_game_strs_su_heldout) | (is_random_ho & game_str %in% new_game_strs_random_heldout) )
```
...
```{r}
meta_d = load_d(results_dir, c("basic", "basic_su_heldout", "basic_random_holdout"), num_runs, "new_meta_true_losses")
