...
summary_plot(reward_d %>%
             ...
             simple_baselines) +
  facet_wrap(. ~ named_run_type)
ggsave("~/Documents/grad/res/psych/ARRR/figures/meta_RL/basic_random_holdout_half.png", width=5, height=3)
```
...
```{r}
language_d = load_d(results_dir, c("language", "language_drop_03", "language_drop_05", "language_noncompositional"), num_runs, "new_language_rewards")
...
ggsave("~/Documents/grad/res/psych/ARRR/figures/meta_RL/basic_basic_random_meta.png", width=5, height=3)
```
